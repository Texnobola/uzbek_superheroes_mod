package net.mcreator.uzbekqahramonlar;
...
@Mod("uzbek_qahramonlar")
public class UzbekQahramonlarMod {
	public static final Logger LOGGER = LogManager.getLogger(UzbekQahramonlarMod.class);
	public static final String MODID = "uzbek_qahramonlar";

	public UzbekQahramonlarMod(FMLJavaModLoadingContext context) {
